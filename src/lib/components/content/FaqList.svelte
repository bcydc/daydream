<script lang="ts">
	...
	export let cloudsImage: string = 'faq-clouds.png';
	export let titleImage: string = 'faq.png';
...
<div
	class="w-full {padding} {bgGradient} relative flex flex-col items-center justify-center"
>
